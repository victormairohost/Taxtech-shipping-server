...
export const strongPasswordValidation = (password: string) => {
  let passwordResult = []
...
export function getDaysBetweenDates(prevDate: string | Date): number {
...
function checkHowManyWeekendsBetweenDates(startDate: Date | string) {
  let result = 0
...
export function setToMidnight(date: Date) {
